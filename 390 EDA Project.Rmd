...
```{r}
boxplot(MonthlyIncome~WorkLifeBalance,data = employee,xlab="PerformanceRating", ylab="MonthlyIncome") + ggtitle("performance vs monthly income")
```
...
ggplot(genderJobIncome, aes(x = JobRole,y = meanSalarybyJob, color = JobRole)) +
    geom_bar(stat = "identity")+ facet_wrap(~ Gender, nrow = 2)+ggtitle("Job distribution among gender")
